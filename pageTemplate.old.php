...
<head>
		...
		<link rel="stylesheet" type="text/css" href="$cssDir/covert.css" media="all"/>
		<link rel="stylesheet" type="text/css" href="$cssDir/styles.old.css" media="all"/>
...
<body>
		...
		<div id="wrap">
				<div id="header"><i>M. genitalium</i> Whole-Cell Model &amp; Knowledge Base</div>
				<div id="nav">$navigationContentHTML</div>
				<div id="sidebar">
$sidebarContentHTML
				</div>
				<div id="main">
				...
				<div id="footer">
						<div class="copyright">
							...
							Contact <img src="$baseDir/images/email.png" class="imgtext" style="top:4px">.
							<br/> &copy; Jonathan Karr, Jayodita Sanghvi, Derek Macklin, Jared Jacobs, and Markus Covert.</div>
				</div>
		</div>
</body>
</html>
