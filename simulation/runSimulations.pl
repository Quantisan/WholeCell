...
<body>
Simulation set <a href="$baseURL/viewSimulationSet.php?id=$conditionSetTimeStamp">#$simulationIdx</a> has been <a href="$gangliaQueueURL">queued</a> with $nJobs simulations. You will receive a summary email upon completion of this simulation set.<br/>
<br/>
